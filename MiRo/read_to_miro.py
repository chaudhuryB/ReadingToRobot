...
from miro2.core.node_decode import *
from miro2.core.node_affect import *
from miro2.core.node_express import *
from miro2.core.node_action import *
from miro2.core.node_loop import *
from miro2.core.node_detect_april import *
from miro2.core.node_detect_motion import *
from miro2.core.node_detect_ball import *
from miro2.core.node_detect_face import *
from miro2.core.node_detect_audio import *
from miro2.core.node_spatial import *
...
class DemoSystem(object):
	...
	def __init__(self, client_type):
		...
		if self.client_type == "camera":
			...
			# subscribe
			self.subscribe('sensors/cam' + self.camera_sub, sensor_msgs.msg.Image, self.callback_cam)
